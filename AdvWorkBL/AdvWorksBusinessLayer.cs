...
namespace AdvWorksBL
{
    public class AdvWorksBusinessLayer
    {
        ...
        {
            AdvWorksDataAccessLayer dalObj = new AdvWorksDataAccessLayer();
            List<DeptDetailsDTO> deptLstFromDAL = dalObj.FetchAllDepartments();
        ...
        {
            List<DeptDetailsDTO> searchedDeptLstFromDAL = dalObj.DepartmentSearchList(deptGroupName);
        ...
        {
            List<ProductsDTO> searchedProdLstFromDAL = dalObj.ProductSearchList(input);
